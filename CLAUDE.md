...
kuliah/
  ...
  jadual/                           ← Schedule system v15.2.2 (dual-view: desktop table + mobile cards)
...
- `kuliah/jadual/CLAUDE.md` — Schedule system v15.2.2 internals (dual-view, print, Apps Script)
