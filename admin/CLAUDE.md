...
- **`admin/staff/`** — a staff **identity/login layer only**, added
  ...
  public-facing login surface (`staff/index.html`, served at `/staff` →
  `POST /api/staff-login`) deliberately never uses Supabase Auth at all — see
