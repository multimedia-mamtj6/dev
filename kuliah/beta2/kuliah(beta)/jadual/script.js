// =================================================================
// SCRIPT.JS - VERSI 15.1 (PEMBETULAN CETAK MUDAH ALIH)
// =================================================================
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // Only render mobile view if NOT in PDF export mode (saves ~65MB on mobile)
        if (!pdfExportMode) {
        ...
        if (pdfExportMode) {
            // Wait for document to be fully loaded (fonts, images, CSS)
            ...
            requestAnimationFrame(() => {
                requestAnimationFrame(() => {
                    // Increased delay for mobile browsers to apply print styles
                    setTimeout(() => {
                        window.print();
                    }, 1000);  // Increased from 250ms to 1000ms for mobile stability
                });
            });
        }
...
// Helper function to ensure document is fully ready before printing
